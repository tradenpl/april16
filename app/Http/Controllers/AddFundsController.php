...
class AddFundsController extends Controller
{
  ...
  $validator = Validator::make($this->request->all(), [
    ...
    switch ($this->request->payment_gateway) {
      ...
      return $this->sendRazorpay();
        ...
        case 'khalti';
        return $this->sendkhalti($this->request->amount,'addfund.khalti.store');
        break;
    }

    return response()->json([
      'success' => true,
      'insertBody' => $this->request->payment_gateway
    ]);
  ...
  protected function sendCoinpayments()
  {
    ...
    {
   return  $this->KhaltiverifyPayment($request);
    }
    ...
    public function storekhaltiPayment(Request $request)
    {
      Log::info([$request]);
          // Insert DB
            ...
            //Add Funds to User
            auth()->user()->increment('wallet', $request->amount);
