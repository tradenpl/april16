...
class TipController extends Controller
{
  ...
  //     ], $messages);
    ...
    switch ($this->request->payment_gateway_tip) {
      ...
      case 2:
        ...
        case 12:
          return $this->sendkhalti($this->request->amount,'tip.khalti.store',$this->request->id,$this->request->isMessage?$this->request->isMessage:null);
          break;
  ...
  protected function storekhaltiPayment(Request $request)
  {
      ...
      $user = User::find($request->message_id);
      // Insert DB
      //========== Processor Fees
